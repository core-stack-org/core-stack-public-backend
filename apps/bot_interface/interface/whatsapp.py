...
CE_API_URL = getattr(settings, "CE_API_URL", "https://geoserver.core-stack.org/api/v1/")
...
#             from geoadmin.models import State
    ...
    def _log_flow_completion(self, bot_instance_id, data_dict, item_type=None):
        ...
        try:
            ...
            # ----------------------------
            try:
                external_api_url = "https://geoserver.core-stack.org/api/v1/upsert_item/"
    ...
    def send_weather_forecast_data_by_location(self, bot_instance_id, data_dict):
        ...
        try:
            ...
            weather_api_url = "https://onix.core-stack.org/api/v1/weather/forecast/5-day/"
            params = {
                "lat": float(latitude),
                "lon": float(longitude),
            }
    ...
    def send_crop_advisory_data_by_location(self, bot_instance_id, data_dict):
        ...
        try:
            ...
            crop_api_url = f"https://onix.core-stack.org/api/v1/crop/advisory/"
