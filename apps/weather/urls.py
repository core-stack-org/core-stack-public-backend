...
from .api import get_current_weather, get_forecast_5day, get_forecast_15day, get_historic_forecast, get_forecast_download
...
urlpatterns = [
    ...
    path("download_forecast/", get_forecast_download, name="download-forecast-weather"),
]